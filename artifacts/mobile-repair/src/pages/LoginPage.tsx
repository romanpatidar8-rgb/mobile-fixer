...
import { Phone, Shield, CheckCircle, ArrowRight, Smartphone } from "lucide-react";
        ...
        {success ? (
          ...
          <div className="bg-white dark:bg-gray-900 rounded-3xl shadow-xl overflow-hidden">
            <div className="bg-gradient-to-r from-blue-600 to-blue-700 p-5 flex items-center gap-3">
              ...
              <span className="text-white text-sm font-medium">Secure OTP Verification</span>
            </div>
            <div className="p-6 flex flex-col gap-5">
              ...
              {!otpSent ? (
                <button onClick={handleSendOTP}
                  className="w-full flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-bold py-3.5 rounded-xl transition-colors shadow">
                  <Phone size={16} />{t("sendOTP")} <ArrowRight size={14} />
                </button>
              ) : (
                <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="flex flex-col gap-4">
                  <div>
                    <div className="flex justify-between items-center mb-2">
                      ...
                      <span className="text-xs text-green-600 font-medium">✓ {t("otpSent")} {mobile}</span>
                    </div>
                  ...
                  <button onClick={handleVerify}
                    className="w-full flex items-center justify-center gap-2 bg-green-500 hover:bg-green-600 text-white font-bold py-3.5 rounded-xl transition-colors shadow">
                    <CheckCircle size={16} />{t("verifyOTP")}
                  </button>
